...
public class VmcraftIiModVariables {
	...
	public static void init(FMLCommonSetupEvent event) {
		VmcraftIiMod.addNetworkMessage(SavedDataSyncMessage.class, SavedDataSyncMessage::buffer, SavedDataSyncMessage::new,
	...
	public static class EventBusVariableHandlers {
		...
		public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
			if (!event.getPlayer().level.isClientSide()) {
				...
				if (mapdata != null)
					VmcraftIiMod.PACKET_HANDLER.send(PacketDistributor.PLAYER.with(() -> (ServerPlayer) event.getPlayer()),
	...
	public static class WorldVariables extends SavedData {
		public static final String DATA_NAME = "vmcraft_ii_worldvars";
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level level && !level.isClientSide())
				VmcraftIiMod.PACKET_HANDLER.send(PacketDistributor.DIMENSION.with(level::dimension), new SavedDataSyncMessage(1, this));
		}
	...
	public static class MapVariables extends SavedData {
		public static final String DATA_NAME = "vmcraft_ii_mapvars";
		...
		public void read(CompoundTag nbt) {
			isError = nbt.getBoolean("isError");
		}

		@Override
		public CompoundTag save(CompoundTag nbt) {
			nbt.putBoolean("isError", isError);
			return nbt;
		}
		...
		public void syncData(LevelAccessor world) {
			...
			if (world instanceof Level && !world.isClientSide())
				VmcraftIiMod.PACKET_HANDLER.send(PacketDistributor.ALL.noArg(), new SavedDataSyncMessage(0, this));
		}
